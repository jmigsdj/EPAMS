  ...
  <div class="box box-success">
    <div class="box-header with-border">
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active"><a href="#">Out Page</a></li>
        </ol>
      </section>
      <br>
    </div><!-- box-body -->
    <div ><!-- /.box-header -->
      <div class="box-body">
        <div class="row">
          <div class="container">
              <h1 style="font-size:20pt">Out Datatable</h1>
              <br />
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('out/ajax_list')?>",
            "type": "POST"
        },
...
function edit_condition(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('out/ajax_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('out/ajax_add')?>";
    } else {
        url = "<?php echo site_url('out/ajax_update')?>";
    }
...
$('#employee_id').select2({
  ajax:{
    ...
    url:'<?=base_url()?>/out/select_employee',
    dataType: 'json',
...
$('#device_id').select2({
  ajax:{
    ...
    url:'<?=base_url()?>/out/select_device',
    dataType: 'json',
    data: function (name, page) {
          return { name: name };
      },
        ...
        <div class="modal-content">
          ...
          <form id="form" onsubmit="return save();"class="form-horizontal">
            <div class="modal-body form">
                    <input type="hidden" value="" name="out_id"/>
                    <div class="form-body">

                      <div class="form-group">
                          <label for="sel1" class="control-label col-md-3">Employee</label>
                          <div class="col-md-9">
                      ...
                      <div class="form-group">
                          <label for="sel1" class="control-label col-md-3">Device</label>
                          <div class="col-md-9">
                              <input type="hidden" name="device_id" id="device_id" class="form-control">
                        </div>
                      </div>
